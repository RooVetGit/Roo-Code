...
if ! code --list-extensions 2>/dev/null | grep -q "CybrosysTechnologies.cybrosys-assista"; then
  code --install-extension CybrosysTechnologies.cybrosys-assista &>/dev/null || exit 1
fi
