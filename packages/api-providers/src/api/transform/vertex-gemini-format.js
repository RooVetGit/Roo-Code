function convertAnthropicContentToVertexGemini(content) {
...
export function convertAnthropicMessageToVertexGemini(message) {
	return {
		role: message.role === "assistant" ? "model" : "user",
		parts: convertAnthropicContentToVertexGemini(message.content),
	}
}
//# sourceMappingURL=vertex-gemini-format.js.map
