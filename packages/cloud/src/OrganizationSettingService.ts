...
export class OrganizationSettingService {
	private static _instance: OrganizationSettingService | null = null
	...
	static get instance() {
		if (!this._instance) {
			throw new Error("OrganizationSettingService not initialized")
		}
	...
	/**
	 * Create the singleton instance of the service.
	 *
	 * @param context The extension context
	 */
	static async createInstance(context: vscode.ExtensionContext, callback: () => void) {
		if (this._instance) {
			throw new Error("OrganizationSettingService instance already created")
		}

		this._instance = new OrganizationSettingService(context, AuthService.instance, callback)
