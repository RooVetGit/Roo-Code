...
- For read-modify-write operations, use the `readModifyFn` parameter of `safeWriteJson` to perform atomic transactions: `safeWriteJson(filePath, undefined, async (data) => { /* modify data in place */ })`
