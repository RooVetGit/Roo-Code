			...
			case "mistake_limit_reached":
				return [
					<span
						className="codicon codicon-error"
						style={{ color: errorColor, marginBottom: "-1.5px" }}></span>,
					<span style={{ color: errorColor, fontWeight: "bold" }}>Seawolf is having trouble...</span>,
				]
			case "command":
				return [
					isCommandExecuting ? (
					...
					<span style={{ color: normalColor, fontWeight: "bold" }}>
						Seawolf wants to execute this command:
					</span>,
				]
			case "use_mcp_server":
				...
				return [
					...
					<span style={{ color: normalColor, fontWeight: "bold" }}>
						Seawolf wants to {mcpServerUse.type === "use_mcp_tool" ? "use a tool" : "access a resource"} on
			...
			case "followup":
				return [
					<span
						...
						style={{ color: normalColor, marginBottom: "-1.5px" }}></span>,
					<span style={{ color: normalColor, fontWeight: "bold" }}>Seawolf has a question:</span>,
				]
			default:
				return [null, null]
		}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>Seawolf wants to edit this file:</span>
						</div>
						<CodeAccordian
			...
			case "newFileCreated":
				return (
					<>
						<div style={headerStyle}>
							{toolIcon("new-file")}
							<span style={{ fontWeight: "bold" }}>Seawolf wants to create a new file:</span>
						</div>
						<CodeAccordian
							isLoading={message.partial}
							code={tool.content!}
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "Seawolf wants to read this file:"
									: "Seawolf read this file:"}
							</span>
						</div>
						{/* <CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "Seawolf wants to view the top level files in this directory:"
									: "Seawolf viewed the top level files in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "Seawolf wants to recursively view all files in this directory:"
									: "Seawolf recursively viewed all files in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "Seawolf wants to view source code definition names used in this directory:"
									: "Seawolf viewed source code definition names used in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? (
									<>
										Seawolf wants to search this directory for <code>{tool.regex}</code>:
									</>
								) : (
									<>
										Seawolf searched this directory for <code>{tool.regex}</code>:
									</>
								)}
							</span>
						</div>
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? (
									<>
										Seawolf wants to switch to <code>{tool.mode}</code> mode
										{tool.reason ? ` because: ${tool.reason}` : ""}
									</>
								) : (
									<>
										Seawolf switched to <code>{tool.mode}</code> mode
										{tool.reason ? ` because: ${tool.reason}` : ""}
									</>
								)}
							</span>
				...
				return (
					<>
						<div style={headerStyle}>
							{toolIcon("new-file")}
							<span style={{ fontWeight: "bold" }}>
								Seawolf wants to create a new subtask in <code>{tool.mode}</code> mode:
							</span>
						</div>
			...
			case "finishTask":
				return (
					<>
						<div style={headerStyle}>
							{toolIcon("checklist")}
							<span style={{ fontWeight: "bold" }}>Seawolf wants to finish this subtask</span>
						</div>
						<div style={{ paddingLeft: "26px", marginTop: "4px" }}>
							<code>{tool.content}</code>
						</div>
