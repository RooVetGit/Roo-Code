...
export const SettingsView: React.FC<SettingsViewProps> = memo(({ onDone }) => {
	...
	const handleSubmit = useCallback(() => {
		try {
			...
			setApiErrorMessage("Failed to save settings. Please try again.")
		}
	}, [
		apiConfiguration,
		glamaModels,
	...
	}, [commandInput, allowedCommands, setAllowedCommands])
				...
				<div style={{ marginBottom: 40 }}>
					...
					<div style={{ marginBottom: 40 }}>
						...
						<p style={{ fontSize: "12px", marginBottom: 15, color: "var(--vscode-descriptionForeground)" }}>
							The following settings allow Roo to automatically perform operations without requiring
