		...
		t: (key: string) => {
			const translations: Record<string, string> = {
				...
				"settings:codeIndex.searchMaxResultsDescription":
					"Maximum number of search results to return (10-200). Lower values provide faster responses, while higher values give more comprehensive results.",
				"settings:codeIndex.searchMaxResultsResetTooltip": "Reset to default value (50)",
...
describe("CodeIndexSettings", () => {
	...
	describe("Search Minimum Score Slider", () => {
		...
		it("should render search max results slider when expanded", () => {
			render(<CodeIndexSettings {...defaultProps} />)

			expandAdvancedConfig()

			expect(screen.getByTestId("search-max-results-slider")).toBeInTheDocument()
