...
export const deepSeekModels = {
	"deepseek-chat": {
		...
		description: `DeepSeek-V3-0324 achieves a significant breakthrough in inference speed over previous models. It tops the leaderboard among open-source models and rivals the most advanced closed-source models globally.`,
	},
	// "deepseek-reasoner": {
	// 	maxTokens: 8192,
	// 	contextWindow: 64_000,
