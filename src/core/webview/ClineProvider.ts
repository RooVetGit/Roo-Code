	...
	*/
	...
	private async updateApiConfiguration(apiConfiguration: ApiConfiguration) {
		...
		await Promise.all([
			...
			this.updateGlobalState("openRouterUseSpecificProvider", openRouterUseSpecificProvider),
			this.updateGlobalState("openRouterSpecificProvider", openRouterSpecificProvider),
	...
	*/
	...
	async getState() {
		const [
			...
			this.getGlobalState("openRouterUseSpecificProvider") as Promise<boolean | undefined>,
			this.getGlobalState("openRouterSpecificProvider") as Promise<string | undefined>,
