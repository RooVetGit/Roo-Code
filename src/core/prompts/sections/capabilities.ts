...
- You can use semantic_search to find code snippets that semantically match a natural language query. This is particularly useful when you need to understand how certain features or components are implemented, without knowing their exact location or naming. The tool will return relevant code snippets along with their file paths and a brief summary.
