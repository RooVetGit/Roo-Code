...
==== CRITICAL RULES ====
- **Shell Command Syntax:** ALL commands sent to \`execute_command\` MUST use syntax compatible with the specified "Default Shell" in the SYSTEM INFORMATION section. For Windows (PowerShell), use semicolons (;) to chain commands (e.g., \`cd C:/Users/matrix/Documents/project-alpha-os-docs; npm install\`). Do NOT use \`&&\` as it will fail. This is a critical, non-negotiable requirement.
========================
