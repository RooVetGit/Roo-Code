...
- When using the semantic_search tool, formulate your queries in natural language that clearly describes what you're looking for. The tool will use the configured model to find and rank relevant code snippets. Use this tool when you need to understand implementations or find code based on its purpose rather than specific text patterns. For best results, combine semantic_search with other tools - for example, use semantic_search to find relevant code areas, then use read_file to examine the complete context of interesting matches.
