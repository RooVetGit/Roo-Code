						...
						items: {
							...
							properties: {
								...
								diff: {
									...
									type: "array",
									description:
										"An array of diff operations to be applied to the file. Combine multiple changes in one request for efficiency.",
									required: true,
									items: {
										name: "diffItem",
										type: "object",
										...
										properties: {
											content_1: {
												...
												type: "string",
												description:
													"The exact block of content to be searched for and replaced.",
												required: true,
											},
											content_2: {
												name: "replace",
												type: "string",
												description: "The new content that will replace the searched block.",
												required: true,
											},
											start_line: {
												name: "start_line",
