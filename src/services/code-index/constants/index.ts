...
export const PARSING_CONCURRENCY = 8
export const MAX_PENDING_BATCHES = 16 // Maximum number of batches to accumulate before waiting

/**OpenAI Embedder */
export const MAX_BATCH_TOKENS = 16384
export const MAX_ITEM_TOKENS = 2048
export const BATCH_PROCESSING_CONCURRENCY = 8
