...
class TelemetryService {
	...
	public captureInsertContentError(taskId: string, consecutiveMistakeCount: number): void {
		this.captureEvent(PostHogClient.EVENTS.ERRORS.INSERT_CONTENT_ERROR, { taskId, consecutiveMistakeCount })
	}
