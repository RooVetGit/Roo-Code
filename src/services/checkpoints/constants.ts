 ...
 *
 * A specialized module within Roo's Checkpoints system that manages file exclusion rules
 ...
 * @deprecated Use getDefaultExclusions() instead
 */
export const GIT_EXCLUDES = getDefaultExclusions()
 ...
 */
export function getMediaFilePatterns(): string[] {
	return [
		"*.jpg",
		"*.jpeg",
		"*.png",
 ...
 */
export function getCacheFilePatterns(): string[] {
	return [
		"*.DS_Store",
		"*.bak",
		"*.cache",
 ...
 */
export function getConfigFilePatterns(): string[] {
 ...
 */
export function getLargeDataFilePatterns(): string[] {
	return [
		"*.zip",
		"*.tar",
		"*.gz",
 ...
 */
export function getDatabaseFilePatterns(): string[] {
	return [
		"*.arrow",
		"*.accdb",
		"*.aof",
 ...
 */
export function getGeospatialPatterns(): string[] {
	return [
		"*.shp",
		"*.shx",
		"*.dbf",
