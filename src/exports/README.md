...
**NOTE:** To ensure that the `idenworks.roo-otto` extension is activated before your extension, add it to the `extensionDependencies` in your `package.json`:

```json
"extensionDependencies": ["idenworks.roo-otto"]
```
