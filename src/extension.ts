...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand("roo-cline.notificationsButtonClicked", () => {
			sidebarProvider.postMessageToWebview({ type: "action", action: "notificationsButtonClicked" })
		}),
	)
